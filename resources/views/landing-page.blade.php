    ...
    <body>
        <header class="with-background">
            <div class="top-nav container">
                ...
                <div class="logo">Get Sneakers Shop</div>
            ...
            <div class="hero container">
                <div class="hero-copy">
                    <h1>Get Sneakers Shop</h1>
                    <p>This is ZEHUA sneakers shop, welcome.</p>


                    <div class="hero-buttons">
                        <a href="https://hiconsumption.com/2017/01/best-sneaker-blogs/" class="button button-white">Blog Post</a>
                        <a href="https://github.com/drehimself/laravel-ecommerce-example" class="button button-white">GitHub</a>
                    </div>
                </div> <!-- end hero-copy -->

                <div class="hero-image">
                    <img src="img/GOAT_HOLIDAY_HERO_GROUPED.png" alt="hero image">
                </div> <!-- end hero-image -->
            </div> <!-- end hero -->
        </header>
        ...
        <div class="featured-section">
            ...
            <div class="container">
                <h1 class="text-center">Get Sneakers Shop</h1>
